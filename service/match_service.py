...
class MatchService:
    ...
    def conclude_match(self, match: Match, result: dict[int, int]) -> dict[int, Player]:
        ...
        player_1_new = Player("pool", player_1_new_rating, player_1_new_rating_deviation, player_1_new_g_of_rd,
                              match.player_one.user_id, "1", "1")
        player_2_new = Player("pool", player_2_new_rating, player_2_new_rating_deviation, player_2_new_g_of_rd,
                              match.player_two.user_id, "1", "1")

        return {
            match.player_one.user_id: player_1_new,
            match.player_two.user_id: player_2_new
        }
